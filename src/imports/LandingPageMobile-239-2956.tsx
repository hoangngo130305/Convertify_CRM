...
import svgPaths from "./svg-9o3p6nb5vj";
  ...
  return (
    <div className="absolute h-[868px] left-[-148px] top-[-34px] w-[1059px]" data-name="Isolation_Mode">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1059 868">
        <g clipPath="url(#clip0_70_1643)" id="Isolation_Mode" opacity="0.2">
...
function Frame2Slide1() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[40px] w-full">Tiết kiệm 75% chi phí quảng cáo</p>
      <p className="font-['Rubik:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] w-full">Tối ưu chiến dịch quảng cáo, tăng chuyển đổi và giảm chi phí lãng phí từ lead kém chất lượng.</p>
    </div>
  );
}
...
function Frame2Slide2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[40px] w-full">CRM đồng bộ Lead đa kênh</p>
      <p className="font-['Rubik:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] w-full">Đồng bộ lead từ Facebook, Zalo, TikTok, Landing Page. Tối ưu quảng cáo và giảm data kém chất lượng.</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[380px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-0 relative size-full">
...
function MobileSliderIndicators({ activeSlide, onSlideChange }: { activeSlide: number; onSlideChange: (slide: number) => void }) {
  return (
    <div className="absolute bottom-[10px] h-[8px] left-1/2 translate-x-[-50%] w-[20px] cursor-pointer z-10">
...
function MobileHero() {
  ...
  return (
    <div className="absolute bg-[#7c3aed] content-stretch flex flex-col gap-[10px] h-[800px] items-start justify-center left-1/2 overflow-clip pb-[15px] pt-[70px] px-[15px] top-[62px] translate-x-[-50%] w-[430px]" data-name="Mobile Hero">
      ...
      <div className="h-[380px] relative shrink-0 w-full transition-opacity duration-500">
        {activeSlide === 0 ? <FrameSlide1 /> : <FrameSlide2 />}
      </div>
      <MobileSliderIndicators activeSlide={activeSlide} onSlideChange={setActiveSlide} />
    </div>
  );
}
  ...
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[30px]" data-name="cloud-off">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g clipPath="url(#clip0_70_1473)" id="cloud-off">
...
function PhoneOff() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[30px]" data-name="phone-off">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g clipPath="url(#clip0_70_1104)" id="phone-off">
  ...
  return (
    <div className="[grid-area:1_/_1] h-[40px] ml-0 mt-0 relative w-[39.998px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39.9977 40">
        <g clipPath="url(#clip0_70_1338)" id="Layer_1">
...
function Capa2() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[40px]" data-name="Capa_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_70_1300)" id="Capa_1">
...
function Layer1() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[40px]" data-name="Layer_2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_70_1271)" id="Layer_2">
...
function Layer4() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[40px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_70_1259)" id="Layer_1">
...
function Layer5() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[40px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_70_1378)" id="Layer_1">
  ...
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[50px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 50">
        <g clipPath="url(#clip0_70_1239)" id="Layer_1">
...
function Icons() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[50px]" data-name="Icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 50">
        <g clipPath="url(#clip0_70_1553)" id="Icons">
          <path d={svgPaths.pca49800} fill="var(--fill-0, #7C3AED)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_70_1553">
            <rect fill="white" height="50" width="50" />
          </clipPath>
        </defs>
      </svg>
  ...
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[100px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 100 100">
        <g clipPath="url(#clip0_70_1229)" id="Layer_1">
...
function Svg() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[100px]" data-name="svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 100 100">
        <g clipPath="url(#clip0_70_1111)" id="svg">
...
function Layer13() {
  return (
    <div className="relative shrink-0 size-[100px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 100 100">
        <g clipPath="url(#clip0_70_1194)" id="Layer_1">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="2">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Convertify hỗ trợ những kênh quảng cáo nào?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="4">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Tôi có thể hủy gói dịch vụ bất cứ lúc nào không?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="5">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Có được hỗ trợ kỹ thuật không?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="6">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Tôi cần bao lâu để thiết lập hệ thống?</span>
        </li>
      </ol>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Bạn có thể bắt đầu sử dụng ngay trong vòng 5 phút. Chỉ cần đăng ký tài khoản, kết nối các kênh quảng cáo của bạn thông qua giao diện đơn giản, và hệ thống sẽ tự động đồng bộ lead. Chúng tôi cũng cung cấp video hướng dẫn từng bước và hỗ trợ trực tiếp nếu bạn cần.</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[624.19px] relative w-[1045px]" data-name="Isolation_Mode">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1045 624.19">
        <g clipPath="url(#clip0_70_1160)" id="Isolation_Mode" opacity="0.2">
...
function Layer15() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[35px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
        <g clipPath="url(#clip0_70_1147)" id="Layer_1">
...
function Svg1() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[35px]" data-name="svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
        <g clipPath="url(#clip0_70_1633)" id="svg">
...
export default function LandingPageMobile({ onRegisterClick }: LandingPageMobileProps = {}) {
  return (
    <div 
      className="bg-white relative w-full min-h-screen flex flex-col items-center overflow-x-hidden" 
      data-name="Landing Page - Mobile"
      onClick={(e) => {
        const target = e.target as HTMLElement;
        const buttonText = target.textContent?.trim();
        
        // Navigate when clicking on register/signup buttons
    ...
    >
      <style>{`
        ...
        /* Remove left-1/2 translate for all children */
        [data-name="Landing Page - Mobile"] > * {
