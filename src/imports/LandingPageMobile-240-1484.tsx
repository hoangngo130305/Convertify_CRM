import svgPaths from "./svg-0rd7vurkp8";
import imgHero1Img1 from "figma:asset/2be47e67227fd376eb094b55ac5112065f82355f.png";
import imgHeroGirl from "figma:asset/150f9ca3e38b4d91359bb1b4ae312b2e35978649.png";
import imgHeroLaptop from "figma:asset/447762b1051f7b59ecdfc42073573b96d7d2fef6.png";
import imgHeroMobile from "figma:asset/06313dc8143eab2d50e165053c710a700a7c33c7.png";
...
import { Frame59, Frame60, Frame61, Frame64, Frame142 } from '../components/TestimonialSection';

// ============================================
// MOBILE HEADER COMPONENTS (Gộp từ MobileHeader.tsx)
// ============================================

function ButtonContact({ onClick }: { onClick: () => void }) {
  return (
    <div 
      className="bg-[#0d6efd] content-stretch flex items-center justify-center pb-[10px] pt-[8px] px-[22px] relative rounded-[3px] shrink-0 hover:bg-transparent hover:border hover:border-white transition-all cursor-pointer group" 
      data-name="Button Contact"
      onClick={onClick}
    >
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white group-hover:text-white">Đăng ký</p>
    </div>
  );
}
...
function MenuIcon({ onClick }: { onClick: () => void }) {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[24px] cursor-pointer hover:opacity-80 transition-opacity" data-name="menu" onClick={onClick}>
...
function MenuGroup({ onClick }: { onClick: () => void }) {
  return (
...
function HeaderFrame({ onMenuClick, onContactClick }: { onMenuClick: () => void; onContactClick: () => void }) {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <ButtonContact onClick={onContactClick} />
      <MenuGroup onClick={onMenuClick} />
    </div>
  );
}
...
function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  const scrollToSection = (sectionId: string) => {
    ...
    setTimeout(() => {
      ...
      // Map section IDs to their actual pixel positions from Figma design
      const sectionPositions: Record<string, number> = {
        'home': 0,           // Top of page
        'problem': 862,      // Frame12 position
        'solution': 1844,    // Frame13 position  
        'features': 4416,    // Frame110 position
        'pricing': 5115,     // Frame116 position
        'testimonial': 10540, // Frame143 position (Khách hàng nói về chúng tôi)
        'faq': 11070         // Frame51 position (Những câu hỏi thường gặp)
      };
  ...
  return (
    <>
      {/* Menu Dropdown */}
      <div 
        className="absolute left-0 right-0 bg-[#7c3aed] shadow-lg z-50 animate-slideDown"
        style={{
          top: '100%',
          width: '100vw',
          marginLeft: 'calc(-1 * max(15px, calc((100vw - 430px) / 2 + 15px)))',
        }}
      >
        <div className="flex flex-col py-4">
          <button
            onClick={() => scrollToSection('home')}
            className="px-6 py-3 text-white text-left font-['Rubik:Medium',sans-serif] text-[16px] hover:bg-white/10 transition-colors"
          >
            Trang chủ
          </button>
          <button
...
function MobileHeader() {
  ...
  const handleContactClick = () => {
    // Trigger login popup - will be handled in parent component
  ...
  return (
    <div 
      className="bg-[#7c3aed] content-stretch flex items-center justify-between shadow-[0px_2px_8px_0px_rgba(0,0,0,0.15)] fixed top-0 left-0 right-0 px-[15px] py-[12px] z-[9999]" 
    ...
    >
      ...
      <HeaderFrame onMenuClick={handleMenuToggle} onContactClick={handleContactClick} />
...
// ============================================
// LANDING PAGE MOBILE COMPONENTS
// ============================================
...
function ButtonCta() {
  return (
    <div className="bg-[#0d6efd] content-stretch flex items-center justify-center pb-[12px] pt-[10px] px-[24px] relative rounded-[3px] shrink-0 hover:bg-transparent hover:border-2 hover:border-white transition-all active:scale-[0.98] cursor-pointer group" data-name="Button CTA">
      <div aria-hidden="true" className="absolute border border-[#0d6efd] border-solid inset-0 pointer-events-none rounded-[3px] group-hover:hidden" />
...
// Frame Slide 1: Mobile Girl Image  
function FrameSlide1() {
  return (
    <div className="h-[380px] relative shrink-0 w-full animate-fade-in">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[45px] py-0 relative size-full">
          <div className="aspect-[515/638] basis-0 grow min-h-px min-w-px relative shrink-0" data-name="hero-mobile-img">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgHeroMobile} />
          </div>
        </div>
      </div>
    </div>
...
// Frame Slide 2: Laptop Image
function FrameSlide2() {
  return (
    <div className="h-[380px] relative shrink-0 w-full animate-fade-in">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[45px] py-0 relative size-full">
          <div className="aspect-[515/638] basis-0 grow min-h-px min-w-px relative shrink-0" data-name="hero-laptop-img">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgHeroLaptop} />
          </div>
        </div>
      </div>
    </div>
...
function Frame({ currentSlide }: { currentSlide: number }) {
  return (
    <>
      {currentSlide === 0 && <FrameSlide1 />}
      {currentSlide === 1 && <FrameSlide2 />}
    </>
  );
}

function Group({ currentSlide }: { currentSlide: number }) {
  return (
    <div className="absolute bottom-[10px] h-[8px] left-1/2 translate-x-[-50%] w-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 8">
        <g id="Group 1">
          <circle cx="4" cy="4" fill="var(--fill-0, white)" id="Ellipse 1" r="4" opacity={currentSlide === 0 ? 1 : 0.25} style={{ transition: 'opacity 0.3s ease-in-out' }} />
          <circle cx="16" cy="4" fill="var(--fill-0, white)" id="Ellipse 2" opacity={currentSlide === 1 ? 1 : 0.25} r="4" style={{ transition: 'opacity 0.3s ease-in-out' }} />
        </g>
      </svg>
    </div>
  );
...
function MobileHero() {
  ...
  return (
    <div className="absolute bg-[#7c3aed] content-stretch flex flex-col gap-[10px] h-[800px] items-start justify-center left-0 overflow-clip pb-[15px] pt-[70px] px-[15px] top-[65px] w-full" data-name="Mobile Hero">
      <IsolationMode />
      <Frame3 />
      <Frame currentSlide={currentSlide} />
      <Group currentSlide={currentSlide} />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-0 pb-[30px] pt-[45px] px-0 top-[862px] w-full">
      <Frame10 />
      <Frame11 />
    </div>
  );
...
function ButtonCta1() {
  return (
    <div className="bg-[#0d6efd] content-stretch flex items-center justify-center pb-[12px] pt-[10px] px-[24px] relative rounded-[3px] shrink-0 hover:bg-transparent hover:border-2 hover:border-black transition-all active:scale-[0.98] cursor-pointer group" data-name="Button CTA">
      <div aria-hidden="true" className="absolute border border-[#0d6efd] border-solid inset-0 pointer-events-none rounded-[3px] group-hover:hidden" />
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[18px] text-nowrap group-hover:text-black text-white">Dùng thử miễn phí</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-0 pb-[15px] pt-[45px] px-0 top-[1844px] w-full">
      <Frame84 />
      <Frame22 />
    </div>
  );
...
function Frame110() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-center left-0 px-0 py-[30px] top-[4416px] w-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(124, 58, 237, 0.05) 0%, rgba(252, 249, 254, 0.05) 30%, rgba(252, 249, 254, 0.05) 70%, rgba(92, 29, 163, 0.05) 100%), linear-gradient(90deg, rgb(252, 249, 254) 0%, rgb(252, 249, 254) 100%)" }}>
      <Frame97 />
      <Frame109 />
      <ButtonCta5 />
    </div>
...
function Frame116() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-0 pb-[30px] pt-[45px] px-0 top-[5500px] w-full">
      <Frame111 />
      <Frame39 />
      <ButtonCta6 />
    </div>
...
function ButtonCta7() {
  return (
    <div className="bg-[#0d6efd] relative rounded-[3px] shrink-0 w-full hover:bg-transparent hover:border-2 hover:border-black transition-all active:scale-[0.98] cursor-pointer group" data-name="Button CTA">
      <div aria-hidden="true" className="absolute border border-[#0d6efd] border-solid inset-0 pointer-events-none rounded-[3px] group-hover:hidden" />
...
function Frame134() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-0 pb-[45px] pt-[30px] px-0 top-[7350px] w-full" style={{ backgroundImage: "linear-gradient(179.09deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame117 />
      <Frame48 />
    </div>
  );
...
function Frame49() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-center left-[15px] right-[15px] pb-[30px] pt-[45px] px-[15px] rounded-[20px] shadow-[0px_10px_25px_-10px_rgba(33,37,41,0.15)] top-[9011px]" style={{ backgroundImage: "linear-gradient(179.399deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame135 />
      <Frame141 />
      <ButtonCta10 />
    </div>
...
/* Testimonial components moved to TestimonialSection.tsx to avoid syntax errors
function Frame142_OLD() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
...
function ButtonCta11_MOVED_HERE() {
return null; // Placeholder
}

/*
// Additional Testimonial Cards for variety (optional - for future expansion)
function TestimonialCard_OLD({ quote, name, title, avatar }: { quote: string; name: string; title: string; avatar: string }) {
  return (
      ...
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[40px] pt-[60px] px-[30px] relative w-full">
        ...
        <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full">
          <div className="relative shrink-0 size-[60px]">
            <img alt={name} className="block max-w-none rounded-full object-cover size-full" height="60" src={avatar} width="60" />
          </div>
          <div className="content-stretch flex flex-col items-start relative shrink-0">
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[32px] relative shrink-0 text-[#212529] text-[23px] w-full">{name}</p>
            <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">{title}</p>
          </div>
        </div>
        <div className="absolute h-[58px] left-[30px] top-[30px] w-[80px]" data-name="&quot;"">
          <div className="absolute inset-0" style={{ "--fill-0": "rgba(124, 58, 237, 1)" } as React.CSSProperties}>
...
End of TestimonialCard comment */
...
function Frame143() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-center left-0 pb-[180px] pt-[120px] px-0 top-[10420px] w-full">
      <Frame142 />
      <Frame64 />
      <ButtonCta11 />
    </div>
    ...
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="1">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Convertify CRM có miễn phí không?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="2">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Tôi có thể kết nối mấy kênh quảng cáo?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="3">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Tôi có thể quản lý bao nhiêu lead?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="4">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Convertify CRM có hỗ trợ tích hợp API không?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="5">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Dữ liệu của tôi có được bảo mật không?</span>
        </li>
      </ol>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[18px] w-full" start="6">
        <li className="ms-[27px]">
          <span className="leading-[normal]">Có hỗ trợ đào tạo sử dụng không?</span>
        </li>
      </ol>
...
function Frame51() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-0 px-0 pt-[120px] pb-[30px] top-[11070px] w-full z-[1]">
      <Frame144 />
      <Frame71 />
    </div>
  );
...
function Frame52() {
  return (
    <div className="absolute bg-[#7c3aed] content-stretch flex flex-col gap-[15px] items-start left-[15px] right-[15px] overflow-clip pb-[30px] pt-[40px] px-[15px] rounded-[20px] top-[12450px]">
...
function Group27() {
  return (
    <div className="absolute contents left-[15px] top-[12700px]">
      <Frame52 />
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-center left-0 pb-[70px] pt-[50px] px-[15px] top-[12850px] w-full">
      <Frame78 />
...
function ButtonCta13() {
  return (
    <div className="absolute bg-[#0d6efd] bottom-0 content-stretch flex gap-[10px] h-[60px] items-center justify-center left-1/2 pb-[12px] pt-[10px] px-[24px] rounded-tl-[10px] rounded-tr-[10px] translate-x-[-50%] w-[430px] z-[9998] hover:bg-transparent hover:border-2 hover:border-black transition-all active:scale-[0.98] cursor-pointer group" data-name="Button CTA">
      <div aria-hidden="true" className="absolute border border-[#0d6efd] border-solid inset-0 pointer-events-none rounded-tl-[10px] rounded-tr-[10px] shadow-[0px_-1px_4px_-1px_rgba(12,12,13,0.1),0px_-1px_4px_-1px_rgba(12,12,13,0.05)] group-hover:hidden" />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[18px] text-nowrap group-hover:text-black text-white">Dùng thử miễn phí</p>
      <Group30 />
    </div>
  );
}
...
function StatusBarIPhone() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[154px] items-center justify-center left-0 pb-[19px] pt-[21px] px-[24px] top-0 w-full" data-name="Status bar - iPhone">
      <Time />
      <Levels />
    </div>
  );
...
export default function LandingPageMobile() {
  return (
    <div className="bg-white relative w-full pb-[180px]" style={{ minHeight: '13300px' }} data-name="Landing Page - Mobile">
      <StatusBarIPhone />
      <div id="home">
        <MobileHero />
      </div>
      ...
      <div className="absolute h-0 left-0 right-0 top-[1844px]">
        <div className="absolute inset-[-1px_0_0_0]" style={{ "--stroke-0": "rgba(204, 204, 204, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 400 1">
