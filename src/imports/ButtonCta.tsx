import svgPaths from "./svg-8w6yar705l";
...
export default function ButtonCta() {
  return (
    <div className="bg-[#0d6efd] content-stretch flex gap-[10px] items-center justify-center pb-[12px] pt-[10px] px-[24px] relative rounded-tl-[10px] rounded-tr-[10px] size-full" data-name="Button CTA">
