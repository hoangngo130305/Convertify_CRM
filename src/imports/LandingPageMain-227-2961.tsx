...
import svgPaths from "./svg-435cbsrbq4";
...
function Frame2Slide1() {
  return (
    <div className="content-stretch flex flex-col gap-[25px] items-start relative shrink-0 text-white w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[64px] w-full">Tiết kiệm 75% chi phí quảng cáo</p>
      <p className="font-['Rubik:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[32px] relative shrink-0 text-[22px] w-full">Tối ưu chiến dịch quảng cáo, tăng chuyển đổi và giảm chi phí lãng phí từ lead kém chất lượng.</p>
    </div>
  );
}

function Frame2Slide2() {
  return (
    <div className="content-stretch flex flex-col gap-[25px] items-start relative shrink-0 text-white w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[64px] w-full">CRM đồng bộ Lead đa kênh</p>
      <p className="font-['Rubik:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[32px] relative shrink-0 text-[22px] w-full">Đồng bộ lead từ Facebook, Zalo, TikTok, Landing Page. Tối ưu quảng cáo và giảm data kém chất lượng.</p>
    </div>
  );
}
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[50px] py-0 relative w-full">
          <div className="aspect-[600/700] basis-0 grow min-h-px min-w-px relative shrink-0" data-name="hero-girl-img">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgHeroGirl} />
          </div>
        </div>
      </div>
    </div>
...
function FrameSlide2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[50px] py-0 relative w-full">
          <div className="aspect-[1000/1000] basis-0 grow min-h-px min-w-px relative shrink-0" data-name="hero-laptop-img">
...
function SliderIndicators({ activeSlide, onSlideChange }: { activeSlide: number; onSlideChange: (slide: number) => void }) {
  return (
    <div className="absolute h-[8px] left-[710px] top-[792px] w-[20px] cursor-pointer z-10">
...
function Frame4() {
  ...
  return (
    <div id="hero" className="absolute bg-[#7c3aed] content-stretch flex gap-[30px] h-[810px] items-center left-1/2 overflow-clip pb-[20px] pt-[80px] px-[45px] top-0 translate-x-[-50%] w-[1440px]">
      <IsolationMode />
      {activeSlide === 0 ? <Frame3Slide1 /> : <Frame3Slide2 />}
      <div className="basis-0 grow min-h-px min-w-px relative shrink-0 transition-opacity duration-500">
        {activeSlide === 0 ? <FrameSlide1 /> : <FrameSlide2 />}
      </div>
      <SliderIndicators activeSlide={activeSlide} onSlideChange={setActiveSlide} />
    </div>
  );
}
...
function Header() {
  return (
    <div className="fixed bg-[#7c3aed] content-stretch flex h-[80px] items-center justify-between left-[calc(50%-8px)] px-[45px] py-0 shadow-[0px_1px_4px_0px_rgba(12,12,13,0.1),0px_1px_4px_0px_rgba(12,12,13,0.05)] top-0 translate-x-[-50%] w-[1440px] z-[9999]" data-name="Header">
...
function Frame12() {
  return (
    <div id="problems" className="absolute content-stretch flex flex-col gap-[40px] items-center left-1/2 px-0 py-[60px] top-[811px] translate-x-[-50%] w-[1440px]">
      <Frame10 />
      <Frame11 />
    </div>
  );
...
function Frame13() {
  return (
    <div id="solutions" className="absolute content-stretch flex flex-col gap-[40px] items-center left-1/2 px-0 py-[60px] top-[1510px] translate-x-[-50%] w-[1440px]">
      <Frame85 />
      <Frame22 />
    </div>
  );
...
function Frame115() {
  return (
    <div id="benefits" className="absolute content-stretch flex flex-col gap-[40px] items-center left-1/2 px-0 py-[60px] top-[4562px] translate-x-[-50%] w-[1440px]">
      <Frame110 />
      <Frame39 />
      <ButtonCta6 />
    </div>
...
function Frame133() {
  return (
    <div id="pricing" className="absolute content-stretch flex flex-col gap-[40px] items-center left-1/2 px-0 py-[60px] top-[5939px] translate-x-[-50%] w-[1440px]" style={{ backgroundImage: "linear-gradient(179.874deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame116 />
      <Frame48 />
    </div>
  );
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[10px] shadow-[0px_10px_25px_-10px_rgba(33,37,41,0.15)] shrink-0" style={{ backgroundImage: "linear-gradient(179.833deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[40px] pt-[60px] px-[30px] relative w-full">
        <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] min-w-full relative shrink-0 text-[#212529] text-[16px] w-[min-content]">Sau khi sử dụng Convertify CRM, chúng tôi tiết kiệm được 40% thời gian quản lý lead. Tính năng đồng bộ đa kênh giúp team sales không bỏ sót bất kỳ khách hàng tiềm năng nào. Hệ thống báo cáo chi tiết giúp tối ưu ngân sách quảng cáo hiệu quả hơn rất nhiều.</p>
        <Frame60 />
...
function Frame59_2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[32px] relative shrink-0 text-[#212529] text-[23px] w-full">Trần Minh Anh</p>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">CEO - Agency Marketing</p>
    </div>
  );
}
...
function Frame61_2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[10px] shadow-[0px_10px_25px_-10px_rgba(33,37,41,0.15)] shrink-0" style={{ backgroundImage: "linear-gradient(179.833deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%))" }}>
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[40px] pt-[60px] px-[30px] relative w-full">
        <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] min-w-full relative shrink-0 text-[#212529] text-[16px] w-[min-content]">Trước đây team phải nhập lead thủ công từ nhiều nguồn, rất tốn thời gian và dễ sai sót. Với Convertify, mọi thứ tự động hoàn toàn. Tính năng phát hiện trùng lặp giúp chúng tôi tiết kiệm hàng triệu đồng mỗi tháng do loại bỏ được data rác.</p>
        <Frame60_2 />
        <div className="absolute h-[58px] left-[30px] top-[30px] w-[80px]" data-name="">
          <div className="absolute inset-0" style={{ "--fill-0": "rgba(124, 58, 237, 1)" } as React.CSSProperties}>
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 58">
...
function Frame59_3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[32px] relative shrink-0 text-[#212529] text-[23px] w-full">Lê Hoàng Phúc</p>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Trưởng phòng Kinh doanh - E-commerce</p>
    </div>
  );
}
...
function Frame61_3() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[10px] shadow-[0px_10px_25px_-10px_rgba(33,37,41,0.15)] shrink-0" style={{ backgroundImage: "linear-gradient(179.833deg, rgba(92, 29, 163, 0.05) 0.20468%, rgba(252, 249, 254, 0.05) 79.877%, rgba(255, 255, 255, 0.05) 99.795%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%))" }}>
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[40px] pt-[60px] px-[30px] relative w-full">
        <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] min-w-full relative shrink-0 text-[#212529] text-[16px] w-[min-content]">Hệ thống báo cáo của Convertify giúp tôi biết chính xác kênh nào mang về khách hàng chất lượng. Từ đó tối ưu ngân sách quảng cáo đúng chỗ, ROI tăng gấp đôi chỉ sau 2 tháng. Đặc biệt thích tính năng tự động phân lead cho sales, không ai bị nhàn rỗi.</p>
        <Frame60_3 />
        <div className="absolute h-[58px] left-[30px] top-[30px] w-[80px]" data-name="">
          <div className="absolute inset-0" style={{ "--fill-0": "rgba(124, 58, 237, 1)" } as React.CSSProperties}>
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 58">
...
function Frame142() {
  return (
    <div id="faqs" className="absolute content-stretch flex flex-col gap-[40px] items-center left-1/2 px-0 py-[60px] top-[7364px] translate-x-[-50%] w-[1440px]">
      <Frame141 />
      <Frame62 />
      <ButtonCta11 />
    </div>
...
function Frame63() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      ...
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Có, chúng tôi cung cấp gói miễn phí vĩnh viễn với tối đa 1.000 leads/tháng và kết nối 2 kênh quảng cáo. Bạn có thể nâng cấp lên gói Pro hoặc Enterprise khi cần thêm tính năng nâng cao và không giới hạn số lượng leads.</p>
    </div>
  );
}
  ...
  return (
    <div className="[grid-area:1_/_2] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[23px] w-full" start="4">
        <li className="ms-[34.5px]">
          <span className="leading-[32px]">Tôi có thể hủy gói dịch vụ bất cứ lúc nào không?</span>
        </li>
      </ol>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Có, bạn có thể hủy gói dịch vụ bất cứ lúc nào mà không mất phí. Dữ liệu của bạn sẽ được giữ an toàn trong 30 ngày sau khi hủy. Trong thời gian này, bạn có thể kích hoạt lại tài khoản hoặc xuất dữ liệu về máy tính.</p>
    </div>
  );
}
  ...
  return (
    <div className="[grid-area:2_/_1] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[23px] w-full" start="2">
        <li className="ms-[34.5px]">
          <span className="leading-[32px]">Convertify hỗ trợ những kênh quảng cáo nào?</span>
        </li>
      </ol>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Chúng tôi hỗ trợ tích hợp với Facebook Lead Ads, Google Ads, TikTok Ads, Zalo Ads, Landing Page tùy chỉnh và nhiều kênh khác. Mọi lead từ các kênh này đều được đồng bộ tự động về một hệ thống duy nhất giúp bạn quản lý dễ dàng.</p>
    </div>
  );
}
  ...
  return (
    <div className="[grid-area:2_/_2] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[23px] w-full" start="5">
        <li className="ms-[34.5px]">
          <span className="leading-[32px]">Có được hỗ trợ kỹ thuật không?</span>
        </li>
      </ol>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Chúng tôi cung cấp hỗ trợ qua email và chat trong giờ hành chính cho tất cả người dùng. Gói Pro và Enterprise có hỗ trợ ưu tiên 24/7 qua chat, điện thoại và được đào tạo sử dụng hệ thống trực tiếp. Bạn cũng có thể truy cập tài liệu hướng dẫn và video tutorial chi tiết.</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="[grid-area:3_/_1] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      ...
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Chúng tôi cam kết bảo mật tuyệt đối dữ liệu khách hàng với mã hóa SSL 256-bit, tuân thủ các tiêu chuẩn bảo mật quốc tế. Dữ liệu của bạn được lưu trữ trên server bảo mật cao và chỉ bạn mới có quyền truy cập. Chúng tôi không chia sẻ thông tin khách hàng cho bên thứ ba.</p>
    </div>
  );
}
  ...
  return (
    <div className="[grid-area:3_/_2] content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      <ol className="block font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] list-decimal relative shrink-0 text-[#212529] text-[23px] w-full" start="6">
        <li className="ms-[34.5px]">
          <span className="leading-[32px]">Tôi cần bao lâu để thiết lập hệ thống?</span>
        </li>
      </ol>
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#757575] text-[16px] w-full">Bạn có thể bắt đầu sử dụng ngay trong vòng 5 phút. Chỉ cần đăng ký tài khoản, kết nối các kênh quảng cáo của bạn thông qua giao diện đơn giản, và hệ thống sẽ tự động đồng bộ lead. Chúng tôi cũng cung cấp video hướng d��n từng bước và hỗ trợ trực tiếp nếu bạn cần.</p>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="absolute bg-[#7c3aed] content-stretch flex flex-col gap-[40px] items-center left-1/2 translate-x-[-50%] overflow-clip pb-[60px] pt-[80px] px-[60px] rounded-[20px] top-[8788px] w-[1350px]">
...
function Group27() {
  return (
    <div className="absolute contents left-1/2 translate-x-[-50%] top-[8788px]">
      <Frame52 />
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start relative shrink-0 w-[315px]">
      ...
      <p className="font-['Rubik:Regular',sans-serif] font-normal leading-[25px] min-w-full relative shrink-0 text-[#212529] text-[16px] w-[min-content]">Convertify CRM - Giải pháp quản lý lead đa kênh toàn diện cho nhà quảng cáo. Tối ưu chi phí, tăng hiệu suất bán hàng.</p>
    </div>
  );
}
...
function ButtonCta13() {
  return (
    <div className="absolute bg-[#0d6efd] bottom-0 content-stretch flex gap-[10px] items-center justify-center left-1/2 pb-[12px] pt-[10px] px-[24px] rounded-tl-[5px] rounded-tr-[5px] translate-x-[-50%] w-[300px] z-[9998]" data-name="Button CTA">
...
export default function LandingPageMain() {
  return (
    <div className="bg-white relative size-full pb-[180px]" data-name="Landing Page - Main">
