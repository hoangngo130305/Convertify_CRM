...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground shadow-sm [a&]:hover:bg-primary-hover [a&]:hover:shadow-md",
        secondary:
          "border-transparent bg-secondary text-secondary-foreground shadow-sm [a&]:hover:bg-secondary-hover",
        destructive:
        ...
        outline:
          "text-foreground border-border [a&]:hover:bg-accent [a&]:hover:text-accent-foreground [a&]:hover:border-border-hover",
        purple:
          "border-transparent bg-gradient-to-r from-primary-light to-primary-lighter text-primary-foreground shadow-sm [a&]:hover:from-primary [a&]:hover:to-primary-light [a&]:hover:shadow-md",
        success:
        ...
        accent:
          "border-transparent bg-accent text-accent-foreground shadow-sm [a&]:hover:bg-accent-hover",
      },
    },
    defaultVariants: {
      variant: "default",
